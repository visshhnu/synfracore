  ...
  return (
    <header style={{
      ...
      <div style={{
        ...
        {/* ── LOGO — actual PNG image, works dark & light ── */}
        <Link href="/" className="logo-wrap" style={{ textDecoration: "none", flexShrink: 0 }}>
          <Image
            src="/logo.png"
            alt="SynfraCore"
            width={169}
      ...
      {mobileOpen && (
        <div style={{
          ...
          <div style={{ padding: "12px 0 16px", borderBottom: "1px solid var(--border)", marginBottom: "12px" }}>
            <Image src="/logo.png" alt="SynfraCore" width={140} height={32}
              style={{ height: "28px", width: "auto" }} />
          </div>

          <p style={{ fontSize: "10px", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--text-4)", marginBottom: "8px" }}>
            Academies
          </p>
          {academies.map(a => (
          ...
          <p style={{ fontSize: "10px", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--text-4)", margin: "16px 0 8px" }}>
            Platform
          </p>
          {simpleNav.map(item => (
