# Nutrition Basics — Quick Reference Cheatsheet
...
**Macronutrients (Carbs, Protein, Fat)**:
  ...
  When to apply: When the problem mentions keywords related to macronutrients (carbs, protein, fat)
**Micronutrients (Vitamins & Minerals)**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to micronutrients (vitamins & minerals)
**Caloric Balance & BMI**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to caloric balance & bmi
**Indian Dietary Guidelines**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to indian dietary guidelines
**Meal Planning**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to meal planning
**Reading Food Labels**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to reading food labels
...
The **Labs** section for Nutrition Basics has:
