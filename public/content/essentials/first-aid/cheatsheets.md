# First Aid & Emergency — Quick Reference Cheatsheet
...
**DRSABCD Protocol**:
  ...
  When to apply: When the problem mentions keywords related to drsabcd protocol
**CPR (Adult, Child, Infant)**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to cpr (adult, child, infant)
**AED Usage**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to aed usage
**Choking (Heimlich Maneuver)**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to choking (heimlich maneuver)
**Bleeding Control**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to bleeding control
**Burns & Scalds**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to burns & scalds
...
The **Labs** section for First Aid & Emergency has:
