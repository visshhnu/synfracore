# Mental Wellness — Quick Reference Cheatsheet
...
**Common Mental Health Conditions**:
  ...
  When to apply: When the problem mentions keywords related to common mental health conditions
**Stress Management Techniques**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to stress management techniques
**Cognitive Behavioral Therapy (CBT) Basics**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to cognitive behavioral therapy (cbt) basics
**Mindfulness & Meditation**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to mindfulness & meditation
**Sleep Hygiene**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to sleep hygiene
**Exercise & Mental Health**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to exercise & mental health
...
The **Labs** section for Mental Wellness has:
