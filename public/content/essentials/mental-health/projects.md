# Mental Wellness — Portfolio Projects

Build these projects to demonstrate real skills to employers. Each project is designed to be interview-worthy — something you can walk through in detail.

## Project 1: Mental Wellness Beginner Project

**Level:** Beginner | **Time:** 2 days

Apply your Mental Wellness fundamentals in a real project. Build something you can show to employers and explain in detail during interviews.

### Steps

1. Define scope: what problem does your Mental Wellness project solve?
...
`mental-health-beginner-project`

---

## Project 2: Mental Wellness Intermediate Project

**Level:** Intermediate | **Time:** 3-4 days

Build a production-quality Mental Wellness project demonstrating intermediate skills. This should be something you're proud to show in interviews.
...
- Mental Wellness intermediate patterns
- Testing
- Error handling

### GitHub Repo Name

`mental-health-intermediate-project`

---

## Project 3: Mental Wellness Capstone Project

**Level:** Advanced | **Time:** 1 week

A comprehensive Mental Wellness project that demonstrates mastery. This should be the centerpiece of your portfolio — something that proves you can do the job.
