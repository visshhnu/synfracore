# Personal Finance — Quick Reference Cheatsheet
...
**Budgeting (50/30/20 Rule)**:
  ...
  When to apply: When the problem mentions keywords related to budgeting (50/30/20 rule)
**Emergency Fund**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to emergency fund
**Debt Management**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to debt management
**Mutual Funds & SIP Investing**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to mutual funds & sip investing
**Insurance (Term, Health)**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to insurance (term, health)
**Tax Planning (Section 80C)**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to tax planning (section 80c)
...
The **Labs** section for Personal Finance has:
