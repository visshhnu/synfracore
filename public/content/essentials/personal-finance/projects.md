# Personal Finance — Portfolio Projects

Build these projects to demonstrate real skills to employers. Each project is designed to be interview-worthy — something you can walk through in detail.

## Project 1: Personal Finance Beginner Project

**Level:** Beginner | **Time:** 2 days

Apply your Personal Finance fundamentals in a real project. Build something you can show to employers and explain in detail during interviews.

### Steps

1. Define scope: what problem does your Personal Finance project solve?
...
`personal-finance-beginner-project`

---

## Project 2: Personal Finance Intermediate Project

**Level:** Intermediate | **Time:** 3-4 days

Build a production-quality Personal Finance project demonstrating intermediate skills. This should be something you're proud to show in interviews.
...
- Personal Finance intermediate patterns
- Testing
- Error handling

### GitHub Repo Name

`personal-finance-intermediate-project`

---

## Project 3: Personal Finance Capstone Project

**Level:** Advanced | **Time:** 1 week

A comprehensive Personal Finance project that demonstrates mastery. This should be the centerpiece of your portfolio — something that proves you can do the job.
