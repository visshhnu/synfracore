# SOC Operations — Portfolio Projects

Build these projects to demonstrate real skills to employers. Each project is designed to be interview-worthy — something you can walk through in detail.

## Project 1: SOC Operations Beginner Project

**Level:** Beginner | **Time:** 2 days

Apply your SOC Operations fundamentals in a real project. Build something you can show to employers and explain in detail during interviews.

### Steps

1. Define scope: what problem does your SOC Operations project solve?
...
## Project 2: SOC Operations Intermediate Project

**Level:** Intermediate | **Time:** 3-4 days

Build a production-quality SOC Operations project demonstrating intermediate skills. This should be something you're proud to show in interviews.
...
- SOC Operations intermediate patterns
- Testing
- Error handling

### GitHub Repo Name

`soc-intermediate-project`

---

## Project 3: SOC Operations Capstone Project

**Level:** Advanced | **Time:** 1 week

A comprehensive SOC Operations project that demonstrates mastery. This should be the centerpiece of your portfolio — something that proves you can do the job.
