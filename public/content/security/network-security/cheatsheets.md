# Network Security — Quick Reference Cheatsheet

## Essential Formulas & Rules

### Core Topics
**Core Network Security Topic 1**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to core network security topic 1
**Core Network Security Topic 2**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to core network security topic 2
**Core Network Security Topic 3**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to core network security topic 3
**Core Network Security Topic 4**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to core network security topic 4
**Core Network Security Topic 5**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to core network security topic 5
**Core Network Security Topic 6**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to core network security topic 6
...
The **Labs** section for Network Security has:
