# Security Fundamentals — Portfolio Projects

Build these projects to demonstrate real skills to employers. Each project is designed to be interview-worthy — something you can walk through in detail.

## Project 1: Security Fundamentals Beginner Project

**Level:** Beginner | **Time:** 2 days

Apply your Security Fundamentals fundamentals in a real project. Build something you can show to employers and explain in detail during interviews.

### Steps

1. Define scope: what problem does your Security Fundamentals project solve?
...
`security-fundamentals-beginner-project`

---

## Project 2: Security Fundamentals Intermediate Project

**Level:** Intermediate | **Time:** 3-4 days

Build a production-quality Security Fundamentals project demonstrating intermediate skills. This should be something you're proud to show in interviews.
...
- Security Fundamentals intermediate patterns
- Testing
- Error handling

### GitHub Repo Name

`security-fundamentals-intermediate-project`

---

## Project 3: Security Fundamentals Capstone Project

**Level:** Advanced | **Time:** 1 week

A comprehensive Security Fundamentals project that demonstrates mastery. This should be the centerpiece of your portfolio — something that proves you can do the job.
...
`security-fundamentals-capstone`
