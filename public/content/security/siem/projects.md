# SIEM — Portfolio Projects

Build these projects to demonstrate real skills to employers. Each project is designed to be interview-worthy — something you can walk through in detail.

## Project 1: SIEM Beginner Project

**Level:** Beginner | **Time:** 2 days

Apply your SIEM fundamentals in a real project. Build something you can show to employers and explain in detail during interviews.

### Steps

1. Define scope: what problem does your SIEM project solve?
...
`siem-beginner-project`

---

## Project 2: SIEM Intermediate Project

**Level:** Intermediate | **Time:** 3-4 days

Build a production-quality SIEM project demonstrating intermediate skills. This should be something you're proud to show in interviews.
...
- SIEM intermediate patterns
- Testing
- Error handling

### GitHub Repo Name

`siem-intermediate-project`

---

## Project 3: SIEM Capstone Project

**Level:** Advanced | **Time:** 1 week

A comprehensive SIEM project that demonstrates mastery. This should be the centerpiece of your portfolio — something that proves you can do the job.
