...
## Project 1: VNets Architecture Design

**Level:** Beginner | **Time:** 2 days

Design and deploy a basic 3-tier application using VNets services. Includes networking, compute, database, and basic security.

### Steps

1. Draw the architecture diagram first (use draw.io or Excalidraw)
2. Set up VNets environment with IaC (Terraform or CloudFormation)
...
`azure-vnets-3tier-architecture`

---

## Project 2: Serverless App on VNets

**Level:** Intermediate | **Time:** 3 days

Build a serverless REST API using VNets managed services. No servers to manage — pay per request, auto-scales to millions.

### Steps

1. Design the API: endpoints, request/response formats
2. Implement using VNets serverless services
...
`azure-vnets-serverless-api`

---

## Project 3: Cost-Optimized VNets Platform

**Level:** Advanced | **Time:** 5 days

Design and implement a production platform on VNets optimized for both reliability and cost. Implement HA, DR, monitoring, and cost management.
...
`azure-vnets-production-platform`
