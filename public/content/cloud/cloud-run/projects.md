...
## Project 1: Cloud Run Architecture Design

**Level:** Beginner | **Time:** 2 days

Design and deploy a basic 3-tier application using Cloud Run services. Includes networking, compute, database, and basic security.

### Steps

1. Draw the architecture diagram first (use draw.io or Excalidraw)
2. Set up Cloud Run environment with IaC (Terraform or CloudFormation)
...
- Cloud Run core services
- IaC
- Cloud security basics

### GitHub Repo Name

`cloud-run-3tier-architecture`

---

## Project 2: Serverless App on Cloud Run

**Level:** Intermediate | **Time:** 3 days

Build a serverless REST API using Cloud Run managed services. No servers to manage — pay per request, auto-scales to millions.

### Steps

1. Design the API: endpoints, request/response formats
2. Implement using Cloud Run serverless services
...
## Project 3: Cost-Optimized Cloud Run Platform

**Level:** Advanced | **Time:** 5 days

Design and implement a production platform on Cloud Run optimized for both reliability and cost. Implement HA, DR, monitoring, and cost management.
