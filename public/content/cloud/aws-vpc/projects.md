# VPC — Portfolio Projects

Build these projects to demonstrate real skills to employers. Each project is designed to be interview-worthy — something you can walk through in detail.

## Project 1: VPC Architecture Design

**Level:** Beginner | **Time:** 2 days

Design and deploy a basic 3-tier application using VPC services. Includes networking, compute, database, and basic security.

### Steps

1. Draw the architecture diagram first (use draw.io or Excalidraw)
2. Set up VPC environment with IaC (Terraform or CloudFormation)
...
`aws-vpc-3tier-architecture`

---

## Project 2: Serverless App on VPC

**Level:** Intermediate | **Time:** 3 days

Build a serverless REST API using VPC managed services. No servers to manage — pay per request, auto-scales to millions.

### Steps

1. Design the API: endpoints, request/response formats
2. Implement using VPC serverless services
...
`aws-vpc-serverless-api`

---

## Project 3: Cost-Optimized VPC Platform

**Level:** Advanced | **Time:** 5 days

Design and implement a production platform on VPC optimized for both reliability and cost. Implement HA, DR, monitoring, and cost management.
