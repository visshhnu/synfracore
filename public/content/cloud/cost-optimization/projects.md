...
## Project 1: Cost Optimization Architecture Design

**Level:** Beginner | **Time:** 2 days

Design and deploy a basic 3-tier application using Cost Optimization services. Includes networking, compute, database, and basic security.

### Steps

1. Draw the architecture diagram first (use draw.io or Excalidraw)
2. Set up Cost Optimization environment with IaC (Terraform or CloudFormation)
...
- Cost Optimization core services
- IaC
- Cloud security basics

### GitHub Repo Name

`cost-optimization-3tier-architecture`

---

## Project 2: Serverless App on Cost Optimization

**Level:** Intermediate | **Time:** 3 days

Build a serverless REST API using Cost Optimization managed services. No servers to manage — pay per request, auto-scales to millions.

### Steps

1. Design the API: endpoints, request/response formats
2. Implement using Cost Optimization serverless services
...
`cost-optimization-serverless-api`

---

## Project 3: Cost-Optimized Cost Optimization Platform

**Level:** Advanced | **Time:** 5 days

Design and implement a production platform on Cost Optimization optimized for both reliability and cost. Implement HA, DR, monitoring, and cost management.
...
`cost-optimization-production-platform`
