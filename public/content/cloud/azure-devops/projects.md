...
## Project 1: Azure DevOps Architecture Design

**Level:** Beginner | **Time:** 2 days

Design and deploy a basic 3-tier application using Azure DevOps services. Includes networking, compute, database, and basic security.

### Steps

1. Draw the architecture diagram first (use draw.io or Excalidraw)
2. Set up Azure DevOps environment with IaC (Terraform or CloudFormation)
...
`azure-devops-3tier-architecture`

---

## Project 2: Serverless App on Azure DevOps

**Level:** Intermediate | **Time:** 3 days

Build a serverless REST API using Azure DevOps managed services. No servers to manage — pay per request, auto-scales to millions.

### Steps

1. Design the API: endpoints, request/response formats
2. Implement using Azure DevOps serverless services
...
`azure-devops-serverless-api`

---

## Project 3: Cost-Optimized Azure DevOps Platform

**Level:** Advanced | **Time:** 5 days

Design and implement a production platform on Azure DevOps optimized for both reliability and cost. Implement HA, DR, monitoring, and cost management.
...
`azure-devops-production-platform`
