# Lambda — Portfolio Projects

Build these projects to demonstrate real skills to employers. Each project is designed to be interview-worthy — something you can walk through in detail.

## Project 1: Lambda Architecture Design

**Level:** Beginner | **Time:** 2 days

Design and deploy a basic 3-tier application using Lambda services. Includes networking, compute, database, and basic security.

### Steps

1. Draw the architecture diagram first (use draw.io or Excalidraw)
2. Set up Lambda environment with IaC (Terraform or CloudFormation)
...
- Lambda core services
- IaC
- Cloud security basics

### GitHub Repo Name

`aws-lambda-3tier-architecture`

---

## Project 2: Serverless App on Lambda

**Level:** Intermediate | **Time:** 3 days

Build a serverless REST API using Lambda managed services. No servers to manage — pay per request, auto-scales to millions.

### Steps

1. Design the API: endpoints, request/response formats
2. Implement using Lambda serverless services
...
## Project 3: Cost-Optimized Lambda Platform

**Level:** Advanced | **Time:** 5 days

Design and implement a production platform on Lambda optimized for both reliability and cost. Implement HA, DR, monitoring, and cost management.
...
`aws-lambda-production-platform`
