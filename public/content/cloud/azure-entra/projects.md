...
## Project 1: Entra ID Architecture Design

**Level:** Beginner | **Time:** 2 days

Design and deploy a basic 3-tier application using Entra ID services. Includes networking, compute, database, and basic security.

### Steps

1. Draw the architecture diagram first (use draw.io or Excalidraw)
2. Set up Entra ID environment with IaC (Terraform or CloudFormation)
...
- Entra ID core services
- IaC
- Cloud security basics

### GitHub Repo Name

`azure-entra-3tier-architecture`

---

## Project 2: Serverless App on Entra ID

**Level:** Intermediate | **Time:** 3 days

Build a serverless REST API using Entra ID managed services. No servers to manage — pay per request, auto-scales to millions.

### Steps

1. Design the API: endpoints, request/response formats
2. Implement using Entra ID serverless services
...
`azure-entra-serverless-api`

---

## Project 3: Cost-Optimized Entra ID Platform

**Level:** Advanced | **Time:** 5 days

Design and implement a production platform on Entra ID optimized for both reliability and cost. Implement HA, DR, monitoring, and cost management.
...
`azure-entra-production-platform`
