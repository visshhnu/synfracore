# Home Health Coding — Intermediate

## From Concepts to Problems

At the intermediate level, you apply fundamental knowledge to solve structured problems. This is where CPC/CCS Certification questions at medium difficulty level fall.
...
For Home Health Coding at intermediate level:
...
Study the **Cheatsheet** section for a compiled list of the most important formulas and rules for Home Health Coding. The **Labs** section has intermediate MCQ sets that test exactly this level.
