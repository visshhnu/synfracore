...
```
REQUIRED: ICD-10-CM + CPT proficiency | E&M coding | anatomy knowledge
SOFTWARE: Epic, Cerner, Meditech, 3M, Optum360, SuperCoder
SOFT SKILLS: attention to detail | accuracy | productivity (lines per hour)
PRODUCTIVITY BENCHMARKS: 60-100 charts/day outpatient | 15-25 inpatient
TYPICAL SALARY: $40,000-$65,000 (remote roles available nationwide)
```
