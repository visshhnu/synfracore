# Coding Guidelines — Quick Reference Cheatsheet
...
**Combination Codes**:
  ...
  When to apply: When the problem mentions keywords related to combination codes
...
The **Labs** section for Coding Guidelines has:
