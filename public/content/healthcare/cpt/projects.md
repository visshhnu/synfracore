# CPT Codes — Portfolio Projects

Build these projects to demonstrate real skills to employers. Each project is designed to be interview-worthy — something you can walk through in detail.

## Project 1: CPT Codes Beginner Project

**Level:** Beginner | **Time:** 2 days

Apply your CPT Codes fundamentals in a real project. Build something you can show to employers and explain in detail during interviews.

### Steps

1. Define scope: what problem does your CPT Codes project solve?
...
`cpt-beginner-project`

---

## Project 2: CPT Codes Intermediate Project

**Level:** Intermediate | **Time:** 3-4 days

Build a production-quality CPT Codes project demonstrating intermediate skills. This should be something you're proud to show in interviews.
...
- CPT Codes intermediate patterns
- Testing
- Error handling

### GitHub Repo Name

`cpt-intermediate-project`

---

## Project 3: CPT Codes Capstone Project

**Level:** Advanced | **Time:** 1 week

A comprehensive CPT Codes project that demonstrates mastery. This should be the centerpiece of your portfolio — something that proves you can do the job.
