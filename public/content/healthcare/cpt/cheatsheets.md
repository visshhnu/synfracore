# CPT Codes — Quick Reference Cheatsheet
...
**E/M Coding (99202-99215)**:
  ...
  When to apply: When the problem mentions keywords related to e/m coding (99202-99215)
**MDM Framework**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to mdm framework
**Time-Based Coding**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to time-based coding
**Global Surgical Package**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to global surgical package
**CPT Modifiers (-22, -25, -51, -59)**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to cpt modifiers (-22, -25, -51, -59)
**Anesthesia Coding**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to anesthesia coding
...
The **Labs** section for CPT Codes has:
