...
## Project 1: HCPCS Level II Beginner Project

**Level:** Beginner | **Time:** 2 days

Apply your HCPCS Level II fundamentals in a real project. Build something you can show to employers and explain in detail during interviews.

### Steps

1. Define scope: what problem does your HCPCS Level II project solve?
...
`hcpcs-beginner-project`

---

## Project 2: HCPCS Level II Intermediate Project

**Level:** Intermediate | **Time:** 3-4 days

Build a production-quality HCPCS Level II project demonstrating intermediate skills. This should be something you're proud to show in interviews.
...
- HCPCS Level II intermediate patterns
- Testing
- Error handling

### GitHub Repo Name

`hcpcs-intermediate-project`

---

## Project 3: HCPCS Level II Capstone Project

**Level:** Advanced | **Time:** 1 week

A comprehensive HCPCS Level II project that demonstrates mastery. This should be the centerpiece of your portfolio — something that proves you can do the job.
