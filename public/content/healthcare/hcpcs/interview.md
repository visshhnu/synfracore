...
```
ROLES USING HCPCS:
  DME billing specialist (supply companies)
  Home health billing coordinator
  Prosthetics and orthotics billing specialist
  Medicare Advantage coding specialist
  Hospice billing coordinator

SALARY: $38,000-$58,000 typical | senior/supervisor roles $65,000-$75,000
CERTIFICATIONS: CPC (AAPC) or CCS (AHIMA) with DME specialty training
```
