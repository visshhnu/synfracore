# ICD-10-CM — Portfolio Projects

Build these projects to demonstrate real skills to employers. Each project is designed to be interview-worthy — something you can walk through in detail.

## Project 1: ICD-10-CM Beginner Project

**Level:** Beginner | **Time:** 2 days

Apply your ICD-10-CM fundamentals in a real project. Build something you can show to employers and explain in detail during interviews.

### Steps

1. Define scope: what problem does your ICD-10-CM project solve?
...
`icd-10-cm-beginner-project`

---

## Project 2: ICD-10-CM Intermediate Project

**Level:** Intermediate | **Time:** 3-4 days

Build a production-quality ICD-10-CM project demonstrating intermediate skills. This should be something you're proud to show in interviews.
...
- ICD-10-CM intermediate patterns
- Testing
- Error handling

### GitHub Repo Name

`icd-10-cm-intermediate-project`

---

## Project 3: ICD-10-CM Capstone Project

**Level:** Advanced | **Time:** 1 week

A comprehensive ICD-10-CM project that demonstrates mastery. This should be the centerpiece of your portfolio — something that proves you can do the job.
