# Linux — Portfolio Projects

Build these projects to demonstrate real skills to employers. Each project is designed to be interview-worthy — something you can walk through in detail.

## Project 1: Production-Grade Linux Setup

**Level:** Beginner | **Time:** 1-2 days

Set up a complete, production-ready Linux environment from scratch with proper configuration, security hardening, and monitoring.

### Steps

1. Plan your Linux architecture and document requirements
2. Install and configure Linux following official best practices
...
## Project 2: Linux CI/CD Pipeline

**Level:** Intermediate | **Time:** 2-3 days

Build a complete CI/CD pipeline using Linux that automatically tests, builds, and deploys a sample application on every commit.

### Steps

1. Create a simple Node.js/Python application with unit tests
2. Write Linux configuration for the pipeline
...
## Project 3: Infrastructure Automation with Linux

**Level:** Advanced | **Time:** 4-5 days

Automate a complete infrastructure deployment using Linux. Deploy a multi-tier application (web + app + database) with full automation, monitoring, and disaster recovery.

### Steps

1. Design the multi-tier architecture (draw diagram first)
2. Write Linux configuration for all components
