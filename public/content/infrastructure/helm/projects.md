...
1. Plan your Helm architecture and document requirements
2. Install and configure Helm following official best practices
...
2. Write Helm configuration for the pipeline
...
2. Write Helm configuration for all components
