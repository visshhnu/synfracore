# AI Agents — Portfolio Projects

Build these projects to demonstrate real skills to employers. Each project is designed to be interview-worthy — something you can walk through in detail.

## Project 1: AI-Powered AI Agents Chatbot

**Level:** Beginner | **Time:** 2 days

Build a conversational chatbot using AI Agents that can answer questions about a specific domain (DevOps, recipes, customer support).

### Steps

1. Design the chatbot persona and scope
2. Implement using AI Agents APIs
...
## Project 2: Document Q&A System with AI Agents

**Level:** Intermediate | **Time:** 3 days

Build a RAG (Retrieval Augmented Generation) system using AI Agents that answers questions about your own documents, PDFs, or knowledge base.
...
4. Integrate AI Agents for answer generation
...
`ai-agents-document-qa`

---

## Project 3: Production AI Agent with AI Agents

**Level:** Advanced | **Time:** 5 days

Build an autonomous AI agent using AI Agents that can complete multi-step tasks: research, write, execute code, interact with APIs — with human oversight.

### Steps

1. Define agent capabilities and tool set
2. Implement agentic loop using AI Agents
