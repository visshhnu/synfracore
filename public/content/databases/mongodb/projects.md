...
## Project 1: MongoDB Schema Design Project

**Level:** Beginner | **Time:** 2 days

Design and implement a real-world database schema for an e-commerce or social media application using MongoDB. Practice normalization, indexing, and query optimization.

### Steps

1. Design the entity-relationship diagram on paper first
2. Implement the schema in MongoDB with proper data types
...
## Project 2: MongoDB Performance Optimization
...
## Project 3: MongoDB Backend for a REST API

**Level:** Advanced | **Time:** 4 days

Build the complete data layer for a production REST API using MongoDB. Includes schema, migrations, stored procedures/aggregations, replication, and monitoring.
