# Power BI — Quick Reference Cheatsheet

## Essential Formulas & Rules

### Core Topics
**Core Power BI Topic 1**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to core power bi topic 1
**Core Power BI Topic 2**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to core power bi topic 2
**Core Power BI Topic 3**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to core power bi topic 3
**Core Power BI Topic 4**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to core power bi topic 4
**Core Power BI Topic 5**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to core power bi topic 5
**Core Power BI Topic 6**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to core power bi topic 6
...
The **Labs** section for Power BI has:
