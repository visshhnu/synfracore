...
## Project 1: Tableau Beginner Project

**Level:** Beginner | **Time:** 2 days

Apply your Tableau fundamentals in a real project. Build something you can show to employers and explain in detail during interviews.

### Steps

1. Define scope: what problem does your Tableau project solve?
...
## Project 2: Tableau Intermediate Project

**Level:** Intermediate | **Time:** 3-4 days

Build a production-quality Tableau project demonstrating intermediate skills. This should be something you're proud to show in interviews.
...
- Tableau intermediate patterns
- Testing
- Error handling

### GitHub Repo Name

`tableau-intermediate-project`

---

## Project 3: Tableau Capstone Project

**Level:** Advanced | **Time:** 1 week

A comprehensive Tableau project that demonstrates mastery. This should be the centerpiece of your portfolio — something that proves you can do the job.
