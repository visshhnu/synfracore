...
For Computer Science at intermediate level:
...
Study the **Cheatsheet** section for a compiled list of the most important formulas and rules for Computer Science. The **Labs** section has intermediate MCQ sets that test exactly this level.
