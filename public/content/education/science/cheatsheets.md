# Science — Quick Reference Cheatsheet
...
**Physics: Motion, Force, Energy**:
  ...
  When to apply: When the problem mentions keywords related to physics: motion, force, energy
**Chemistry: Matter, Reactions, Periodic Table**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to chemistry: matter, reactions, periodic table
**Biology: Cell, Life Processes, Genetics, Ecology**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to biology: cell, life processes, genetics, ecology
**Scientific Method & Experiments**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to scientific method & experiments
...
The **Labs** section for Science has:
