# Data Structures & Algorithms — Quick Reference Cheatsheet
...
**Linked Lists**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to linked lists
**Stacks & Queues**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to stacks & queues
**Trees & BST**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to trees & bst
**Graphs (BFS/DFS)**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to graphs (bfs/dfs)
**Sorting Algorithms**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to sorting algorithms
...
The **Labs** section for Data Structures & Algorithms has:
