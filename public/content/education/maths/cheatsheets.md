# Mathematics — Quick Reference Cheatsheet
...
**Algebra & Functions**:
  ...
  When to apply: When the problem mentions keywords related to algebra & functions
**Trigonometry**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to trigonometry
**Calculus (Differential & Integral)**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to calculus (differential & integral)
**Probability & Statistics**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to probability & statistics
**Coordinate Geometry**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to coordinate geometry
**Vectors & 3D Geometry**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to vectors & 3d geometry
...
The **Labs** section for Mathematics has:
