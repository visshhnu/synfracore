# Placement Preparation — Quick Reference Cheatsheet
...
**Quantitative Aptitude**:
  ...
  When to apply: When the problem mentions keywords related to quantitative aptitude
**Logical & Verbal Reasoning**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to logical & verbal reasoning
**Technical DSA (LeetCode)**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to technical dsa (leetcode)
**System Design (for Senior roles)**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to system design (for senior roles)
**HR Behavioral Questions**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to hr behavioral questions
**Resume & LinkedIn Optimization**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to resume & linkedin optimization
...
The **Labs** section for Placement Preparation has:
