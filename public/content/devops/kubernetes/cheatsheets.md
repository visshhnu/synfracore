...
kubectl debug node/<node> -it --image=busybox   # busybox lacks most diagnostic tools -- for a
                                                  # genuinely useful node shell, use a real toolbox
                                                  # image instead, e.g. --image=nicolaka/netshoot
