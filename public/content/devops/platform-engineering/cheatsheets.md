# Platform Engineering Key Tools

| Category | Tools |
|----------|-------|
| Developer portal | Backstage (Spotify/CNCF) |
| Self-service infra | Crossplane, Terraform Cloud |
| GitOps engine | ArgoCD, FluxCD |
| Service mesh | Istio, Linkerd |
| Observability | Prometheus, Grafana, Datadog |
| CI/CD | Tekton, GitHub Actions, Jenkins |
| Secret management | HashiCorp Vault, External Secrets |
| Registry | Harbor, ECR, ACR |
