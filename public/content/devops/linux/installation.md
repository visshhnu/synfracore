...
### AWS Free Tier — verified update: this changed in July 2025

**If your AWS account was created before July 15, 2025:** the old model applies — 12 months of free usage on eligible services (EC2, S3, RDS) within stated limits.

**If you're creating a new AWS account today:** AWS replaced that model with a credit-based system. New accounts choose a Free or Paid plan, both starting with $100 in credits (growing to $200 by completing onboarding tasks), valid for 6 months or until credits run out. This is a meaningfully different setup than "12 months free" — track your credit balance, since the account behaves like a prepaid balance rather than a fixed-duration free allowance.

1. Create account at aws.amazon.com
2. Go to EC2 → Launch Instance
3. Choose: Ubuntu 22.04 LTS (or current LTS)
4. Instance type: a small/free-eligible type under whichever plan you're on
5. Create a key pair (.pem file)
6. Launch — and set a cost budget alert immediately, regardless of which model your account is on
...
You have Linux access. Go to the **Fundamentals** tab to start learning the core commands used daily in DevOps work.
