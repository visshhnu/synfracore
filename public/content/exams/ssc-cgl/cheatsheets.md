# SSC CGL — Quick Reference Cheatsheet
...
**General Intelligence & Reasoning**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to general intelligence & reasoning
**General Awareness**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to general awareness
**English Comprehension**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to english comprehension
**Tier 2: Statistics (Paper 2)**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to tier 2: statistics (paper 2)
**Tier 2: Finance & Economics (Paper 3)**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to tier 2: finance & economics (paper 3)
...
The **Labs** section for SSC CGL has:
