...
At the intermediate level, you apply fundamental knowledge to solve structured problems. This is where SSC CGL questions at medium difficulty level fall.
...
For SSC CGL at intermediate level:
...
Study the **Cheatsheet** section for a compiled list of the most important formulas and rules for SSC CGL. The **Labs** section has intermediate MCQ sets that test exactly this level.
