# SSC CGL — Portfolio Projects

Build these projects to demonstrate real skills to employers. Each project is designed to be interview-worthy — something you can walk through in detail.

## Project 1: SSC CGL Beginner Project

**Level:** Beginner | **Time:** 2 days

Apply your SSC CGL fundamentals in a real project. Build something you can show to employers and explain in detail during interviews.

### Steps

1. Define scope: what problem does your SSC CGL project solve?
...
`ssc-cgl-beginner-project`

---

## Project 2: SSC CGL Intermediate Project

**Level:** Intermediate | **Time:** 3-4 days

Build a production-quality SSC CGL project demonstrating intermediate skills. This should be something you're proud to show in interviews.
...
- SSC CGL intermediate patterns
- Testing
- Error handling

### GitHub Repo Name

`ssc-cgl-intermediate-project`

---

## Project 3: SSC CGL Capstone Project

**Level:** Advanced | **Time:** 1 week

A comprehensive SSC CGL project that demonstrates mastery. This should be the centerpiece of your portfolio — something that proves you can do the job.
