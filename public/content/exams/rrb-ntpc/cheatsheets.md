# RRB NTPC — Quick Reference Cheatsheet
...
**Mathematics (Arithmetic, Algebra, Geometry)**:
  ...
  When to apply: When the problem mentions keywords related to mathematics (arithmetic, algebra, geometry)
...
**Current Affairs**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to current affairs
**Railway GK**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to railway gk
...
The **Labs** section for RRB NTPC has:
