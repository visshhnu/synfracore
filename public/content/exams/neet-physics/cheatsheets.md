# NEET Physics — Quick Reference Cheatsheet
...
**Mechanics**:
  ...
  When to apply: When the problem mentions keywords related to mechanics
**Electrostatics**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to electrostatics
**Optics**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to optics
**Modern Physics**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to modern physics
**Thermodynamics**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to thermodynamics
**Waves**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to waves
...
The **Labs** section for NEET Physics has:
