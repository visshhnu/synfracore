# JEE Chemistry — Quick Reference Cheatsheet
...
**Mole Concept & Stoichiometry**:
  ...
  When to apply: When the problem mentions keywords related to mole concept & stoichiometry
**Chemical Bonding & Structure**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to chemical bonding & structure
**Thermodynamics & Equilibrium**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to thermodynamics & equilibrium
**Electrochemistry**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to electrochemistry
**Organic Chemistry (GOC, Named Reactions)**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to organic chemistry (goc, named reactions)
**Coordination Compounds**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to coordination compounds
...
The **Labs** section for JEE Chemistry has:
