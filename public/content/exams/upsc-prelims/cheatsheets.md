# UPSC Prelims — Quick Reference Cheatsheet
...
**Indian History (Ancient, Medieval, Modern)**:
  ...
  When to apply: When the problem mentions keywords related to indian history (ancient, medieval, modern)
**Geography (Physical, Indian, World)**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to geography (physical, indian, world)
**Indian Polity & Constitution**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to indian polity & constitution
**Economy (Basic Concepts, Budget, Banking)**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to economy (basic concepts, budget, banking)
**Science & Technology**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to science & technology
**Environment & Ecology**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to environment & ecology
...
The **Labs** section for UPSC Prelims has:
