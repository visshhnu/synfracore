# UPSC Prelims — Portfolio Projects

Build these projects to demonstrate real skills to employers. Each project is designed to be interview-worthy — something you can walk through in detail.

## Project 1: UPSC Prelims Beginner Project

**Level:** Beginner | **Time:** 2 days

Apply your UPSC Prelims fundamentals in a real project. Build something you can show to employers and explain in detail during interviews.

### Steps

1. Define scope: what problem does your UPSC Prelims project solve?
...
`upsc-prelims-beginner-project`

---

## Project 2: UPSC Prelims Intermediate Project

**Level:** Intermediate | **Time:** 3-4 days

Build a production-quality UPSC Prelims project demonstrating intermediate skills. This should be something you're proud to show in interviews.
...
- UPSC Prelims intermediate patterns
- Testing
- Error handling

### GitHub Repo Name

`upsc-prelims-intermediate-project`

---

## Project 3: UPSC Prelims Capstone Project

**Level:** Advanced | **Time:** 1 week

A comprehensive UPSC Prelims project that demonstrates mastery. This should be the centerpiece of your portfolio — something that proves you can do the job.
