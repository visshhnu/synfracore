# JEE Mathematics — Quick Reference Cheatsheet
...
**Limits & Continuity**:
  ...
  When to apply: When the problem mentions keywords related to limits & continuity
**Derivatives & Integration**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to derivatives & integration
**Matrices & Determinants**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to matrices & determinants
**Probability**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to probability
**Coordinate Geometry**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to coordinate geometry
**Complex Numbers**:
  Key formula/rule: See fundamentals section for complete derivation
  When to apply: When the problem mentions keywords related to complex numbers
...
The **Labs** section for JEE Mathematics has:
