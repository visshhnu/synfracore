# UPSC Mains — Portfolio Projects

Build these projects to demonstrate real skills to employers. Each project is designed to be interview-worthy — something you can walk through in detail.

## Project 1: UPSC Mains Beginner Project

**Level:** Beginner | **Time:** 2 days

Apply your UPSC Mains fundamentals in a real project. Build something you can show to employers and explain in detail during interviews.

### Steps

1. Define scope: what problem does your UPSC Mains project solve?
...
`upsc-mains-beginner-project`

---

## Project 2: UPSC Mains Intermediate Project

**Level:** Intermediate | **Time:** 3-4 days

Build a production-quality UPSC Mains project demonstrating intermediate skills. This should be something you're proud to show in interviews.
...
- UPSC Mains intermediate patterns
- Testing
- Error handling

### GitHub Repo Name

`upsc-mains-intermediate-project`

---

## Project 3: UPSC Mains Capstone Project

**Level:** Advanced | **Time:** 1 week

A comprehensive UPSC Mains project that demonstrates mastery. This should be the centerpiece of your portfolio — something that proves you can do the job.
