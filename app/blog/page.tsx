...
export const metadata = { title: "Blog — SynfraCore", description: "Latest articles, tutorials, and insights from the SynfraCore team." };
...
export default function Page() {
  return (
    <div style={{ maxWidth: "800px", margin: "0 auto", padding: "64px 24px" }}>
      ...
      <h1 style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: "36px", fontWeight: 800, color: "var(--text-1)", marginBottom: "16px" }}>Blog</h1>
      <p style={{ color: "var(--text-3)", fontSize: "16px", lineHeight: 1.7, marginBottom: "24px" }}>Latest articles, tutorials, and insights from the SynfraCore team.</p>
