  ...
  return (
    <div style={{ minHeight: "70vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: "40px 24px", background: "var(--bg)" }}>
      ...
      <div style={{ display: "flex", gap: "12px", flexWrap: "wrap", justifyContent: "center" }}>
        ...
        <Link href="/academies" style={{ background: "var(--bg-2)", border: "1px solid var(--border)", color: "var(--text-1)", padding: "11px 24px", borderRadius: "10px", fontSize: "14px", fontWeight: 600, textDecoration: "none" }}>
          Browse Academies
        </Link>
      </div>
    </div>
