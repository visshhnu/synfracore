...
const roadmapDetails: Record<string, {
  ...
  "devops-engineer": {
    ...
    techLinks: [
      { name: "Linux & Shell", academy: "devops", slug: "linux" },
      { name: "Git & Shell Scripting", academy: "devops", slug: "git" },
      { name: "Kubernetes", academy: "devops", slug: "kubernetes" },
      { name: "CI/CD — Jenkins", academy: "devops", slug: "jenkins" },
      { name: "Cloud — AWS EC2", academy: "cloud", slug: "aws-ec2" },
  ...
  "cloud-architect": {
    ...
    techLinks: [
      ...
      { name: "AWS Core Services", academy: "cloud", slug: "aws-ec2" },
      { name: "Azure Core Services", academy: "cloud", slug: "azure-aks" },
      { name: "Networking & Security", academy: "cloud", slug: "cloud-security" },
      { name: "Architecture Patterns", academy: "cloud", slug: "landing-zones" },
  ...
  "platform-engineer": {
    ...
    techLinks: [
      { name: "Linux & Networking", academy: "devops", slug: "linux" },
  ...
  "ai-engineer": {
    ...
    techLinks: [
      { name: "Python Foundations", academy: "devops", slug: "python" },
  ...
  "database-engineer": {
    ...
    techLinks: [
      ...
      { name: "Cloud Databases", academy: "databases", slug: "dynamodb" },
    ],
  ...
  "data-engineer": {
    ...
    techLinks: [
      { name: "Python & Pandas", academy: "data", slug: "pandas" },
      { name: "SQL Advanced", academy: "databases", slug: "sql" },
      ...
      { name: "Cloud Data Warehouses", academy: "cloud", slug: "bigquery" },
    ],
  ...
  "sre-engineer": {
    ...
    techLinks: [
      ...
      { name: "Chaos Engineering", academy: "devops", slug: "ha-dr" },
      { name: "Capacity Planning", academy: "devops", slug: "slo" },
      { name: "Automation", academy: "devops", slug: "platform-engineering" },
    ],
  ...
  "healthcare-coder": {
    ...
    techLinks: [
      { name: "Medical Terminology", academy: "healthcare", slug: "patient-documentation" },
  ...
  "advocate-career": {
    ...
    techLinks: [
      ...
      { name: "Junior Advocate Practice", academy: "law", slug: "legal-fundamentals" },
      { name: "Build Specialisation", academy: "law", slug: "consumer-protection" },
      { name: "Independent Practice", academy: "law", slug: "clat-prep" },
    ],
  ...
  "upsc-ias": {
    ...
    techLinks: [
      { name: "History, Polity, Geography", academy: "economics", slug: "indian-economy" },
      { name: "Economy & Environment", academy: "economics", slug: "micro-economics" },
      ...
      { name: "Essay + Ethics (GS4)", academy: "law", slug: "constitutional-law" },
      { name: "Interview / Personality Test", academy: "exams", slug: "upsc-mains" },
    ],
  ...
  "banking-po": {
    ...
    techLinks: [
      { name: "Quantitative Aptitude", academy: "exams", slug: "banking-exam" },
      { name: "Reasoning Ability", academy: "exams", slug: "banking-exam" },
      { name: "English Language", academy: "exams", slug: "banking-exams" },
      { name: "General/Banking Awareness", academy: "finance", slug: "banking-rbi" },
  ...
  "state-psc-officer": {
    ...
    techLinks: [
      { name: "State GK + Language", academy: "state-psc", slug: "tnpsc" },
      { name: "Indian Polity & History", academy: "law", slug: "constitutional-law" },
      { name: "Prelims (state-specific)", academy: "state-psc", slug: "kpsc" },
      { name: "Mains + State-specific papers", academy: "state-psc", slug: "mpsc" },
      { name: "Judgment / Essay Writing", academy: "economics", slug: "indian-economy" },
      { name: "Interview", academy: "economics", slug: "budget-analysis" },
    ],
  ...
  "ca-journey": {
    ...
    techLinks: [
      ...
      { name: "Register for Articleship", academy: "finance", slug: "ca-cs-foundation" },
      ...
      { name: "3-Year Articleship", academy: "finance", slug: "ca-intermediate" },
      { name: "CA Final Group I", academy: "finance", slug: "gst-taxation" },
      { name: "CA Final Group II + AICITSS", academy: "finance", slug: "direct-tax" },
    ],
  ...
  "banking-finance-analyst": {
    ...
    techLinks: [
      ...
      { name: "Credit Analysis Fundamentals", academy: "finance", slug: "banking-rbi" },
      { name: "CA/MBA or NISM Certifications", academy: "finance", slug: "ca-cs-foundation" },
      { name: "Role: Analyst / RM", academy: "economics", slug: "indian-economy" },
    ],
  ...
  "agricultural-officer": {
    ...
    techLinks: [
      ...
      { name: "Agricultural Economics & Policy", academy: "agriculture", slug: "icar-ibps-afo" },
  ...
  "neet-medical": {
    ...
    techLinks: [
      ...
      { name: "Previous Year Questions (10 years)", academy: "exams", slug: "neet-biology" },
      { name: "Mock Tests + Revision", academy: "exams", slug: "gate" },
    ],
  ...
  "jee-engineering": {
    ...
    techLinks: [
      ...
      { name: "JEE Advanced (IIT shortlist)", academy: "exams", slug: "gate" },
      { name: "JOSAA Counselling", academy: "education", slug: "school" },
    ],
  ...
  "personal-wellness": {
    ...
    techLinks: [
      ...
      { name: "Daily Movement", academy: "essentials", slug: "mental-health" },
