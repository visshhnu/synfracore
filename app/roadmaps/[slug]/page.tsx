...
const roadmapDetails: Record<string, {
  ...
  "state-psc-officer": {
    ...
    techLinks: [
      ...
      { name: "Constitutional Law", academy: "law", slug: "constitutional-law" },
      { name: "State PSC — TNPSC", academy: "state-psc", slug: "tnpsc" },
      { name: "State PSC — KPSC", academy: "state-psc", slug: "kpsc" },
      { name: "Budget Analysis", academy: "economics", slug: "budget-analysis" },
    ],
  ...
  "neet-medical": {
    ...
    techLinks: [
      { name: "NEET Biology", academy: "exams", slug: "neet-biology" },
      { name: "NEET Physics", academy: "exams", slug: "neet-physics" },
      { name: "NEET Chemistry", academy: "exams", slug: "neet-chemistry" },
      { name: "UPSC Prelims (Biology overlap)", academy: "exams", slug: "upsc-prelims" },
    ],
