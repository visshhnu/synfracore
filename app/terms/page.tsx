...
export default function TermsPage() {
  const sections = [
    ...
    { title: "Pricing", content: "SynfraCore is currently free to use — there is no paid subscription tier today. If paid plans are introduced in the future, this section will be updated with billing, cancellation, and refund terms before those features launch, and you will be notified in advance." },
    ...
    { title: "Limitation of Liability", content: "SynfraCore shall not be liable for indirect, incidental, or consequential damages arising from use of the platform, to the maximum extent permitted by law." },
  ...
  return (
    <div style={{ maxWidth: "760px", margin: "0 auto", padding: "56px 24px" }}>
      ...
      <p style={{ color: "var(--text-4)", fontSize: "14px", marginBottom: "40px" }}>Last updated: July 2026 · Questions: hello@synfracore.com</p>
