...
const CAREER_CLUSTERS = [
  {
    ...
    careers: [
      ...
      { title: "Security Engineer", icon: "🛡️", salary: "₹10L–₹45L", demand: "High", roadmap: "/roadmaps/security-engineer", academy: "/academies/security", skills: ["Network Security", "SIEM", "Pen Testing", "Cloud Sec."], entry: "IT background + CEH/OSCP" },
  ...
  },
  {
    ...
    careers: [
      { title: "Advocate / Litigator", icon: "⚖️", salary: "₹3L–₹50L+ (variable)", demand: "Stable", roadmap: "/roadmaps/advocate-career", academy: "/academies/law", skills: ["Court procedure", "Drafting", "Legal research", "AIBE"], entry: "LLB degree + Bar Council enrollment" },
      { title: "Civil Judge / Judicial Officer", icon: "🏛️", salary: "₹13L–₹25L (govt)", demand: "Competitive exam", roadmap: "/roadmaps/judiciary-civil-judge", academy: "/academies/law", skills: ["Constitutional law", "CPC", "Criminal law", "Judgment writing"], entry: "LLB + State PSC exam" },
  ...
  },
  {
    ...
    careers: [
      { title: "IAS / IPS / IFS (UPSC)", icon: "🏛️", salary: "₹56K–₹2.5L/mo (govt) + perks", demand: "Extremely Competitive", roadmap: "/roadmaps/upsc-ias", academy: "/academies/exams", skills: ["General Studies I–IV", "Optional subject", "Essay", "Interview"], entry: "Any graduation + UPSC exam" },
      { title: "State PSC Officer", icon: "🏛️", salary: "₹35K–₹1.5L/mo", demand: "Competitive", roadmap: "/roadmaps/state-psc-officer", academy: "/academies/state-psc", skills: ["State GK", "State language", "Polity", "Economy"], entry: "Graduation + State PSC exam" },
  ...
  },
  {
    ...
    careers: [
      ...
      { title: "EdTech Content Creator", icon: "🖥️", salary: "₹4L–₹20L", demand: "Growing", roadmap: null, academy: "/academies/education", skills: ["Subject expertise", "Video creation", "Content structuring"], entry: "Any subject expertise + content skills" },
    ],
  },
  {
