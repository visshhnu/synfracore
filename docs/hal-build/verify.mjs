// Generic post-seed verifier: node docs/hal-build/verify.mjs <paper-slug>
import { config } from "dotenv";
import { createClient } from "@supabase/supabase-js";

const slug = process.argv[2];
if (!slug) { console.error("Usage: node docs/hal-build/verify.mjs <paper-slug>"); process.exit(1); }
