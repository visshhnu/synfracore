...
// paper: node docs/neet-build/check-stems.mjs <key>
// <key> examples: "neet1".."neet5" -- registry file: neet-stem-registry.json
import { readFileSync, writeFileSync, existsSync } from "node:fs";

const key = process.argv[2];
if (!key) { console.error("Usage: node docs/neet-build/check-stems.mjs <key>"); process.exit(1); }

const REGISTRY_PATH = `d:/synfracore/docs/neet-build/neet-stem-registry.json`;
