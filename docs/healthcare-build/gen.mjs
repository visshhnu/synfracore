// Generic generator: node docs/healthcare-build/gen.mjs <key>
// Reads docs/healthcare-build/<key>-data.mjs, writes docs/<key>_seed.sql
// with {{TOKEN}} UUID placeholders. Run scripts/fill-seed-uuids.mjs on the
// output afterward. Same process used for HAL/AWS SAA/Security+.
// <key> examples: "ccs1", "ccs2", ... "cpt1", "cpt2", ...
import { writeFileSync } from "node:fs";

const key = process.argv[2];
if (!key) { console.error("Usage: node docs/healthcare-build/gen.mjs <key>"); process.exit(1); }
