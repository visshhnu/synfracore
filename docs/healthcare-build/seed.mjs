// Generic production seeder: node docs/healthcare-build/seed.mjs <key>
// Parses docs/<key>_seed.sql and writes it via the Supabase
...
if (!key) { console.error("Usage: node docs/healthcare-build/seed.mjs <key>"); process.exit(1); }
...
for (const stmt of statements) {
  ...
  if (stmt.includes("question_papers")) {
    ...
    questions.push({ id: fields[0], paper_id: fields[1], sort_order: Number(fields[2]), question_text: fields[3] });
