// Blog post content — the single source of truth for both the blog detail
// page and app/sitemap.ts, which derives its real blog-slug list from
// Object.keys(articles) here instead of maintaining a separate hardcoded
// list (which had already drifted — see
// docs/audit/03-performance-seo-a11y.md Finding 3).
export const articles: Record<string, { title: string; tag: string; date: string; readTime: string; body: string[] }> = {
