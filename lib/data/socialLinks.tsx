// SynfraCore's real social accounts — every profile URL here was
// independently verified live (2026-09-12/13), not guessed:
// github.com/synfracore's own self-declared profile links (a real, active
// account with matching bio/repos) list these exact canonical URLs.
// Instagram is on hold — a real @synfracore account is being created; add
// it here once confirmed live, not before. WhatsApp is a direct
// click-to-chat link (wa.me/<number>) to a number the user gave directly,
// not a profile-existence check like the others — different kind of
// "account" by nature, nothing to independently verify.
//
