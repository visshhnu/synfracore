...
export const roadmapDetails: Record<string, RoadmapDetail> = {
  ...
  "aerospace-engineer": {
    ...
    salaryRange: "₹4L – ₹12L (India, freshers) | ₹6L–₹10L ISRO | ₹15L–₹50L+ (senior/MNC)",
  ...
  "vlsi-design-engineer": {
    ...
    salaryRange: "₹4L – ₹6L (India, services fresher) | ₹15L–₹30L (Tier-1 product fresher: Intel/Qualcomm/NVIDIA) | ₹25L–₹50L+ (senior)",
