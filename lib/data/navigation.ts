...
export const techSections = [
  { slug: "overview", label: "Overview", icon: "[R]", description: "What it is, why it matters, architecture and key concepts" },
  { slug: "fundamentals", label: "Fundamentals", icon: "[F]", description: "Core concepts and commands — hands-on from the start" },
  ...
  { slug: "roadmap", label: "Roadmap", icon: "[M]", description: "Step-by-step structured learning path from zero to expert" },
  { slug: "labs", label: "Labs", icon: "[L]", description: "Hands-on exercises with real environments and scenarios" },
  { slug: "projects", label: "Projects", icon: "[P]", description: "Portfolio-ready projects to demonstrate your skills" },
  { slug: "interview", label: "Interview Q&A", icon: "[Q]", description: "Most asked interview questions with detailed answers" },
  { slug: "troubleshooting", label: "Troubleshooting", icon: "[T]", description: "Debug common issues with root cause analysis" },
  { slug: "certification", label: "Certification", icon: "[C]", description: "Exam guides, practice questions, and prep strategies" },
  { slug: "cheatsheets", label: "Cheatsheets", icon: "[S]", description: "Quick reference — commands, syntax, and patterns" },
  { slug: "notes", label: "Notes", icon: "[N]", description: "Key takeaways, tips, and important points to remember" },
  { slug: "real-world-scenarios", label: "Real World", icon: "[W]", description: "Production stories, incidents, and how experts solve them" },
...
export const stats = [
  ...
  { label: "Career Paths", value: "22", icon: "[M]" },
  { label: "Free Forever", value: "100%", icon: "*" },
];

export const roadmaps = [
  // ── TECH TRACKS ────────────────────────────────────────────────────────────
  { slug: "devops-engineer", title: "DevOps Engineer", icon: "⚙", color: "#3B82F6", category: "tech", duration: "6 months",
    steps: ["Linux & Shell", "Git & Docker", "Kubernetes", "CI/CD Pipelines", "Cloud (AWS/Azure)", "Monitoring & IaC"] },
  { slug: "cloud-architect", title: "Cloud Architect", icon: "☁", color: "#0EA5E9", category: "tech", duration: "8 months",
  ...
  { slug: "platform-engineer", title: "Platform Engineer", icon: "[P]", color: "#6366F1", category: "tech", duration: "9 months",
  ...
  { slug: "security-engineer", title: "Security Engineer", icon: "*", color: "#EF4444", category: "tech", duration: "7 months",
    steps: ["Security Fundamentals", "Network Security", "Cloud Security", "SIEM & SOC", "Pen Testing", "Ethical Hacking", "Incident Response"] },
  { slug: "database-engineer", title: "Database Engineer", icon: "*", color: "#10B981", category: "tech", duration: "6 months",
    steps: ["SQL Mastery", "PostgreSQL Advanced", "Redis & Caching", "MongoDB", "Database Design", "Performance Tuning", "Cloud Databases"] },
  { slug: "data-engineer", title: "Data Engineer", icon: "[T]", color: "#F59E0B", category: "tech", duration: "8 months",
  ...
  // ── LAW & LEGAL ────────────────────────────────────────────────────────────
  { slug: "advocate-career", title: "Advocate / Legal Career", icon: "⚖", color: "#6366F1", category: "law", duration: "3–5 years",
  ...
  { slug: "judiciary-civil-judge", title: "Judiciary — Civil Judge", icon: "*", color: "#A855F7", category: "law", duration: "1–2 years prep",
  ...
  // ── GOVERNMENT / PSC ───────────────────────────────────────────────────────
  { slug: "upsc-ias", title: "UPSC Civil Services (IAS/IPS)", icon: "*", color: "#F59E0B", category: "government", duration: "2–4 years",
  ...
  { slug: "state-psc-officer", title: "State PSC — Civil Services", icon: "*", color: "#8B5CF6", category: "government", duration: "1–3 years",
...
export const nonTechSections = [
  { slug: "overview",       label: "Overview",     icon: "[R]", description: "What it covers, why it matters, and how to use this guide" },
  { slug: "fundamentals",   label: "Fundamentals", icon: "[F]", description: "Core concepts, definitions, and foundational knowledge" },
  ...
  { slug: "notes",          label: "Notes",        icon: "[N]", description: "Key takeaways, mnemonics, and revision points" },
  { slug: "cheatsheets",    label: "Quick Ref",    icon: "[S]", description: "At-a-glance summaries, tables, and quick reference cards" },
  { slug: "interview",      label: "Practice Q&A", icon: "[Q]", description: "Practice questions, past paper patterns, and model answers" },
