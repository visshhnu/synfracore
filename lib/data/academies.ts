  ...
  domains: [
    ...
    },
    {
      ...
      technologies: [
        ...
        { slug: "kubernetes", name: "Kubernetes", icon: "☸", description: "Container orchestration — Pods, Deployments, Services, networking, and production ops", level: "Advanced", tags: ["Orchestration", "CNCF", "K8s"] },
    ...
    },
    {
      ...
      color: "#7C3AED",
      technologies: [
        { slug: "terraform", name: "Terraform", icon: "[P]", description: "HashiCorp Terraform — modules, state, workspaces, and production patterns", level: "Intermediate", tags: ["IaC", "HashiCorp", "Provisioning"] },
  ...
  domains: [
    {
      ...
      technologies: [
        ...
        { slug: "aws-ec2", name: "EC2", icon: "*", description: "Virtual machines, auto-scaling, launch templates, spot instances", level: "Beginner", tags: ["Compute", "VMs", "Auto-Scaling"] },
        { slug: "aws-vpc", name: "VPC", icon: ">", description: "Virtual Private Cloud — subnets, routing, NAT, security groups, endpoints", level: "Intermediate", tags: ["Networking", "Security", "Subnets"] },
        { slug: "aws-s3", name: "S3", icon: "*", description: "Object storage — policies, versioning, lifecycle, events, CloudFront", level: "Beginner", tags: ["Storage", "Object Store", "CDN"] },
        { slug: "aws-rds", name: "RDS & Aurora", icon: "*", description: "Managed relational databases — MySQL, PostgreSQL, Aurora Serverless", level: "Intermediate", tags: ["Database", "MySQL", "PostgreSQL"] },
        ...
        { slug: "aws-eks", name: "EKS", icon: "☸", description: "Managed Kubernetes — node groups, Fargate, IRSA, ALB controller", level: "Advanced", tags: ["Kubernetes", "Managed", "IRSA"] },
        { slug: "cloudformation", name: "CloudFormation", icon: "[S]", description: "AWS native IaC — stacks, templates, change sets, nested stacks", level: "Advanced", tags: ["IaC", "Templates", "CDK"] },
        { slug: "route53", name: "Route53", icon: "[W]", description: "DNS — routing policies, health checks, failover, latency routing", level: "Intermediate", tags: ["DNS", "Routing", "HA"] },
      ],
    },
    {
      slug: "azure",
      ...
      color: "#3B82F6",
      technologies: [
        { slug: "azure-entra", name: "Entra ID", icon: "*", description: "Azure AD — SSO, MFA, RBAC, conditional access, managed identity", level: "Intermediate", tags: ["Identity", "SSO", "RBAC"] },
        ...
        { slug: "azure-vnets", name: "VNets", icon: ">", description: "Virtual Networks, peering, NSGs, private endpoints, ExpressRoute", level: "Intermediate", tags: ["Networking", "NSG", "Peering"] },
        { slug: "azure-aks", name: "AKS", icon: "☸", description: "Azure Kubernetes Service — node pools, workload identity, upgrades", level: "Advanced", tags: ["Kubernetes", "Managed", "Workload Identity"] },
    ...
    },
    {
      ...
      color: "#10B981",
      technologies: [
        { slug: "gke", name: "GKE", icon: "☸", description: "Google Kubernetes Engine — Autopilot, node pools, workload identity", level: "Advanced", tags: ["Kubernetes", "Google", "Autopilot"] },
  ...
  domains: [
    ...
    },
    {
      ...
      technologies: [
        ...
        { slug: "cassandra", name: "Cassandra", icon: ">", description: "Wide-column distributed database — CQL, consistency levels, partitioning", level: "Advanced", tags: ["Wide-column", "Distributed", "CQL"] },
  ...
  domains: [
    {
      ...
      technologies: [
        ...
        { slug: "prompt-engineering", name: "Prompt Engineering", icon: "✍", description: "Zero-shot, few-shot, CoT, ReAct, system prompts — master LLM communication", level: "Beginner", tags: ["Prompts", "LLMs", "Techniques"] },
      ],
    },
    {
      slug: "llm-apps",
    ...
    },
    {
      ...
      color: "#F59E0B",
      technologies: [
        { slug: "llmops", name: "LLMOps", icon: "⚙", description: "Production LLM ops — prompt versioning, caching, evaluation, guardrails, cost", level: "Advanced", tags: ["LLMOps", "Production", "Monitoring"] },
...
const securityAcademy: Academy = {
  ...
  domains: [
    ...
    },
    {
      ...
      color: "#8B5CF6",
      technologies: [
        { slug: "soc", name: "SOC Operations", icon: ">", description: "SOC tiers, MITRE ATT&CK, alert triage, incident response playbooks", level: "Intermediate", tags: ["SOC", "MITRE", "Incident Response"] },
  ...
  domains: [
    {
      ...
      color: "#F43F5E",
      technologies: [
        { slug: "icd-10-cm", name: "ICD-10-CM", icon: "[S]", description: "International Classification of Diseases — structure, guidelines, sequencing, POA, HCC", level: "Beginner", tags: ["ICD-10", "Diagnosis", "CMS"] },
        ...
        { slug: "coding-guidelines", name: "Coding Guidelines", icon: "[R]", description: "OGCR, inpatient vs outpatient, UHDDS, uncertain diagnoses, sequencing rules", level: "Intermediate", tags: ["Guidelines", "OGCR", "HCC"] },
        { slug: "mock-exams", name: "Mock Exams & CPC Prep", icon: "[N]", description: "CPC, CCS, CCA exam practice — case studies, timed tests, detailed explanations", level: "Advanced", tags: ["CPC", "CCS", "Certification"] },
      ],
    },
    {
      slug: "home-health",
      ...
      technologies: [
        ...
        { slug: "bchhc-prep", name: "BCHHC Certification Prep", icon: "[C]", description: "Board Certified Home Health Coder exam prep — OASIS, PDGM, ICD-10-CM coding scenarios, timed mock exams", level: "Advanced", tags: ["BCHHC", "Certification", "Home Health", "OASIS", "PDGM"] },
      ],
    },
    {
      slug: "hospitality",
  ...
  domains: [
    ...
    },
    {
      ...
      technologies: [
        ...
        { slug: "os", name: "Operating Systems", icon: "⚙", description: "Processes, memory management, file systems, synchronization — GATE and placement prep", level: "Intermediate", tags: ["OS", "GATE", "Processes"] },
        { slug: "dbms", name: "DBMS", icon: "*", description: "Relational algebra, SQL, normalization, transactions, GATE questions", level: "Intermediate", tags: ["DBMS", "SQL", "GATE"] },
        ...
        { slug: "system-design", name: "System Design", icon: "[P]", description: "LLD and HLD for tech interviews — design patterns, scalability, real systems", level: "Advanced", tags: ["System Design", "Interviews", "LLD/HLD"] },
        ...
        { slug: "c-programming", name: "C Programming", icon: "[T]", description: "C language fundamentals — pointers, memory management, data structures, system programming", level: "Beginner", tags: ["C", "Pointers", "Systems"] },
  ...
  domains: [
    {
      ...
      technologies: [
        ...
        { slug: "neet-chemistry", name: "NEET Chemistry", icon: "[L]", description: "NEET Chemistry — organic, inorganic, physical with NCERT-based questions", level: "Advanced", tags: ["NEET", "Chemistry", "Medical"] },
        ...
        { slug: "jee-chemistry", name: "JEE Chemistry", icon: "[L]", description: "Organic, inorganic, physical chemistry for JEE Main and Advanced", level: "Advanced", tags: ["JEE", "Chemistry", "IIT"] },
      ],
    },
    {
      slug: "gate",
    ...
    },
    {
      ...
      technologies: [
        ...
        { slug: "ssc-cgl", name: "SSC CGL", icon: "[S]", description: "Tier I & II — Quant, English, GK, Reasoning for SSC CGL and CHSL", level: "Beginner", tags: ["SSC", "CGL", "Government"] },
    ...
    },
    {
      ...
      color: "#F43F5E",
      technologies: [
        { slug: "upsc-prelims", name: "UPSC Prelims", icon: "*", description: "GS Paper I & II (CSAT) — History, Geography, Polity, Economy, Science, Current Affairs", level: "Advanced", tags: ["UPSC", "IAS", "CSE"] },
        { slug: "upsc-mains", name: "UPSC Mains", icon: "✍", description: "Essay, GS Papers I-IV, Optional subject strategy and answer writing", level: "Advanced", tags: ["UPSC", "IAS", "Mains"] },
      ],
    },
  ],
  technologies: [],
...
const lawAcademy: Academy = {
  ...
  domains: [
    { slug: "exams-practice", name: "Legal Exams & Practice", icon: "⚖", description: "Bar exam, judiciary, legal career", color: "#6366F1",
      technologies: [
    ...
    { slug: "core-law", name: "Core Law Subjects", icon: ">", description: "Foundational legal subjects", color: "#8B5CF6",
      technologies: [
        ...
        { slug: "constitutional-law", name: "Constitutional Law", icon: "*", description: "Preamble, Fundamental Rights, DPSP, Amendment, Basic Structure doctrine, federalism", level: "Intermediate", tags: ["Constitution", "FRs", "UPSC"] },
...
const agricultureAcademy: Academy = {
  ...
  domains: [{ slug: "farming", name: "Farming & Agriculture", icon: ">", description: "Core agriculture subjects", color: "#22C55E",
    technologies: [
      ...
      { slug: "soil-science", name: "Soil Science", icon: "[W]", description: "Soil types, texture, structure, pH, nutrients, conservation, land management", level: "Intermediate", tags: ["Soil", "Fertility", "Conservation"] },
      ...
      { slug: "icar-ibps-afo", name: "ICAR JRF / IBPS AFO Exam Prep", icon: "[C]", description: "ICAR JRF, IBPS AFO, NABARD Grade A/B — syllabus, crop production, government schemes, MSP, PM-KISAN", level: "Intermediate", tags: ["ICAR", "IBPS AFO", "NABARD", "Exam"] },
...
const statePscAcademy: Academy = {
  ...
  domains: [{ slug: "state-civil-services", name: "State Civil Services", icon: "*", description: "State PSC exam preparation", color: "#8B5CF6",
    technologies: [
      { slug: "tnpsc", name: "TNPSC Prep", icon: "*", description: "Tamil Nadu PSC — Samacheer Kalvi, Tamil language, state-specific GK, Group I-IV", level: "Beginner", tags: ["TNPSC", "Tamil Nadu", "State PSC"] },
      { slug: "kpsc", name: "KPSC Prep", icon: "*", description: "Karnataka PSC — Kannada language, state history/geography/economy, FDA/SDA/KAS", level: "Beginner", tags: ["KPSC", "Karnataka", "KAS"] },
      { slug: "mpsc", name: "MPSC Prep", icon: "*", description: "Maharashtra PSC — Marathi language, state-specific content, Group A/B posts", level: "Beginner", tags: ["MPSC", "Maharashtra", "MCS"] },
      { slug: "appsc", name: "APPSC Prep", icon: "*", description: "Andhra Pradesh PSC — Telugu medium, AP history/economy, Group I/II/III/IV", level: "Beginner", tags: ["APPSC", "Andhra Pradesh"] },
      { slug: "tspsc", name: "TSPSC Prep", icon: "*", description: "Telangana PSC — Telugu medium, Telangana movement, TS economy, Group I/II/III/IV", level: "Beginner", tags: ["TSPSC", "Telangana"] },
    ]
  }],
  technologies: [],
};
...
const centralExamsAcademy: Academy = {
  ...
  domains: [{ slug: "central-recruitment", name: "Central Recruitment", icon: "[S]", description: "Central government examination preparation", color: "#EC4899",
    technologies: [
      ...
      { slug: "nda-prep", name: "NDA Preparation", icon: ">", description: "NDA Maths + GAT — detailed topic-wise preparation with PYQs", level: "Intermediate", tags: ["NDA", "Defence", "UPSC"] },
    ]
  }],
  technologies: [],
};
...
const professionalCertsAcademy: Academy = {
  ...
  domains: [{ slug: "professional-development", name: "Professional Development", icon: "*", description: "Industry certifications", color: "#14B8A6",
    technologies: [
      ...
      { slug: "itil", name: "ITIL 4 Foundation", icon: "⚙", description: "IT service management — ITIL 4 SVS, four dimensions, practices, 40-MCQ exam", level: "Beginner", tags: ["ITIL", "ITSM", "Service Management"] },
...
const economicsAcademy: Academy = {
  ...
  domains: [{ slug: "economics-core", name: "Economics", icon: "*", description: "Core economics subjects", color: "#F97316",
    technologies: [
      ...
      { slug: "international-trade", name: "International Trade", icon: "[W]", description: "BoP, forex, WTO, trade policy, globalisation, FDI/FII in India", level: "Advanced", tags: ["Trade", "WTO", "BoP", "Forex"] },
      { slug: "budget-analysis", name: "Union Budget & Economic Survey", icon: "[S]", description: "Fiscal deficit, capex, GDP measurement, inflation, government schemes — UPSC/Banking", level: "Intermediate", tags: ["Budget", "Fiscal Policy", "GDP", "UPSC"] },
